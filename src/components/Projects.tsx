...
const projectsData: Project[] = [
    { name: "Atomus Project", language: "React", imgUrl: "/PortfolioSerious/projectsImg/AtomusV1/homepage.png", description: "Projet qui concerne l'ecologie , en cours de developement", url:"https://github.com/Hanakhin/AtomUsSolution-main"},
    { name: "AirBnb clone Project", language: "PHP", imgUrl: "/PortfolioSerious/projectsImg/TPairbnb/homepage.png", description: "Projet réalisé a l'idem dans le cadre d'un TP PHP",url:"https://github.com/Hanakhin/TP_PHP_IDEM_ERN24_HANAKHIN" },
