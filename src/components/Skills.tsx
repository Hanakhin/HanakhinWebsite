...
const SkillGrid: React.FC<{ skills: Skill[] }> = ({ skills }) => (
    <div className="grid-skills grid-cols-3 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-8">
...
// Main component
const Skills: React.FC<{ onPageChange: (direction: 'prev' | 'next') => void }> = ({ onPageChange }) => {
    return (
